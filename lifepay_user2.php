	...
	<div class="wrapper">
		<nav id="leftNav" class="hidden-xs">
			<ul >
				...
				<a href="manage_Invoice.php" ><li  class="active"><img src="img/account.png" width="73px" alt=""></li></a>
		...
		<nav id="bottomNav" class="visible-xs" style="z-index: 999">
			<ul >
				...
				<a href="manage_Invoice.php" ><li class="active " style="width: 20%"><img src="img/account.png" width="50px" alt=""></li></a>
