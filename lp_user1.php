...
if ($totalRows_Recf != 0)
{
  ...
  $m_username = $row_Recf['m_username'];
}else {$a = "會員資料不對!!!";}
...
<nav class="bottomNav" style="z-index: 999">
  ...
  <a href="person_main.php" style="color: #595757">
    <li style="width: 20%">
      ...
      <div class=" ">
        <div align="center"><img src="img/lp_home-active.png" width="30px" alt=""></div>
      </div>  
    </li> 
    </a>
    ...
    <div class=" " >
      <div align="center"><img src="img/lp_map.png" width="30px" alt=""></div>
    </div>
    </li>
    </a> 
...
<div><span style="font-size: 22px">意見回饋</span><span style="position: absolute; left: 33px; top:5px;color: #fff;font-size: 30px;font-weight: 300;z-index: 999" class="btn4">X</span></div>
  ...
  <div align="left" style="border-bottom: 1px solid #eee;line-height: 40px;padding: 5px;width: 90%;margin: 0px auto;margin-top: 20px"><div align="left" style="font-size: 14px;color: #999;display: inline-block;width: 30%;padding-left: 10px;vertical-align: top;">意見回饋：</div><div align="left" style="color: #65A89A;font-size: 14px;display: inline-block;width: 70%;padding-left: 20px"><textarea name="content" type="text" class="pay_user " placeholder="感謝您的寶貴意見，串門子雲盟事業將不斷進步，為使用者創造更優秀的商務平台！" style="background: #C9C9C9;color: #fff;border-radius: 6px;border:0px;height: 40vh;width: 100%;padding: 5px"> </textarea></div></div>
...
<div id="box6" style="background:#fff;height:100%;width:100%;top:100%; position: fixed;z-index:1001;overflow: scroll;display: none;">
  <div class="mebr_top" align="center" style="background:#84DDCB;color: #fff;padding: 13px;height: 50px ">
