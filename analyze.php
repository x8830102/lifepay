...
<a href="manage_analyze_store.php"><button>商家交易統計</button></a>
<a href="manage_analyze_person.php"><button>消費族群分析</button></a>
<a href="manage_analyze_industry.php"><button>積分產業分佈</button></a>
<a href="manage_analyze_signup.php"><button>LIFE LINK註冊統計</button></a>
<a href="integral.php"><button>積分流通統計</button></a>
