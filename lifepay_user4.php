	...
	<div class="wrapper">
		<nav id="leftNav" class="hidden-xs">
			<ul >
				...
				<a href="manage_inquire_person.php"><li  class="active"><img src="img/user_infor.png" width="73px" alt=""></li></a>
		...
		<nav id="bottomNav" class="visible-xs" style="z-index: 999">
			<ul >
				...
				<a href="manage_inquire_person.php"><li class="active " style="width: 20%"><img src="img/user_infor.png" width="50px" alt=""></li></a>
