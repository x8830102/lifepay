	...
	<div class="wrapper">
		<nav id="leftNav" class="hidden-xs">
			<ul >
				...
				<a href="manage_inquire_store.php"><li ><img src="img/shop_info.png" width="73px" alt=""></li></a>
				<a href="manage_inquire_person.php"><li  ><img src="img/user_infor.png" width="73px" alt=""></li></a>
				<a href="manage_analyze_store.php"><li class="active"><img src="img/analytics-01.png" width="73px" alt=""></li></a>
			</ul>
		</nav>
		<nav id="bottomNav" class="visible-xs" style="z-index: 999">
			<ul >
				...
				<a href="manage_inquire_store.php"><li style="width: 20%"><img src="img/shop_info.png" width="50px" alt=""></li></a>
				<a href="manage_inquire_person.php"><li  style="width: 20%"><img src="img/user_infor.png" width="50px" alt=""></li></a>
				<a href="manage_analyze_store.php"><li class="active "  style="width: 20%"><img src="img/analytics-01.png" width="50px" alt=""></li></a>
			</ul>
		</nav>
