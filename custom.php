...
<a href="signup/signup.php"><button>商店開通</button></a>
<a href="manage_inquire_person.php"><button>使用者消費紀錄</button></a>
<a href="manage_inquire_store.php"><button>店家營業紀錄</button></a>
