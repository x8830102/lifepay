...
<div class=" " align="center" style="">
  ...
  <ul style="margin-top: -10px">
    <li  class="col-lg-12 col-md-12 col-xs-12" style="list-style: none;background: #84ddcb;height: 60px"><input id="st_name" name="st_name" type="text" placeholder="收藏搜尋" style="width: 80%;background: #77C7B6;border-radius: 6px;border: 0px;color: #fff;padding:8px;margin-top: 10px;vertical-align: middle;"></li></ul>
</form>
</div></div>
<nav class="bottomNav" style="z-index: 999">
  ...
  <a href="person_main.php" style="color: #595757">
    ...
    <li style="width: 20%"> 
        ...
        <div class=" " >
          <div align="center"><img src="img/lp_like-active.png" width="30px" alt=""></div>
        </div>
    </li>
    </a> 
